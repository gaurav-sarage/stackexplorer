...
export const PhotonEngineIcon: React.FC<IconProps> = ({ size }) => (
  <svg
    width={`${size}px`}
    height={`${size}px`}
    viewBox="0 0 76.27 76.27"
  ...
  >
    <defs>
      ...
      >
        <stop offset="0.19" stopColor="#71d7fc" />
        <stop offset="0.29" stopColor="#67caf1" />
        <stop offset="0.47" stopColor="#4ea9d5" />
        <stop offset="0.7" stopColor="#2574a9" />
        <stop offset="0.89" stopColor="#004480" />
      </linearGradient>
    </defs>
